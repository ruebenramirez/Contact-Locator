...
function territoryExists($name=null, $is_US) {	
	$debugSW = false;
	...
	$sqlTerritoryExists = "SELECT id FROM territories WHERE name = '".addslashes($name)."' AND us = '".$is_US."'";
	if($debugSW) {
		echo "<br />".$sqlTerritoryExists."<br />";
	}
...
if(isset($_POST) && !empty($_POST)) {
	...
	if (isset($_POST['name']) && !territoryExists($_POST['name'], $submission_is_US)) {
